...
public class DanhMucKhachHang {
    ...
    private RichShowDetailItem tabLichSuBanHang;
    private RichShowDetailItem tabNoCanThuTuKhach;
    ...
    public void setTabLichSuBanHang(RichShowDetailItem tabLichSuBanHang) {
        this.tabLichSuBanHang = tabLichSuBanHang;
    }

    public RichShowDetailItem getTabLichSuBanHang() {
        return tabLichSuBanHang;
    }

    public void setTabNoCanThuTuKhach(RichShowDetailItem tabNoCanThuTuKhach) {
        this.tabNoCanThuTuKhach = tabNoCanThuTuKhach;
    }

    public RichShowDetailItem getTabNoCanThuTuKhach() {
        return tabNoCanThuTuKhach;
    }
